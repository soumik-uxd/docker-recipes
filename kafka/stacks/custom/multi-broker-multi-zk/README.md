...
The docker-compose file will start a stack of services i.e. there instances of [Zookeeer](https://zookeeper.apache.org/) instance and three instances of Kafka brokers.
...
docker-compose up -d
```
The zookeeper instance should start at ports 2181,2182 and 2183 and the kafka broker at ports 9092, 9093 and 9094 respectively.
