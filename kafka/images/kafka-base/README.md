...
This is a Dockerfile for building a base docker image for [Apache Kafka](https://kafka.apache.org/), which will be further used to create images for Kafka brokers, connect etc. It is based on the [Eclipse Temurin](https://hub.docker.com/_/eclipse-temurin) JRE images.
